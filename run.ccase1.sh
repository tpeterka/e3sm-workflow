...
# Machine and project
readonly MACHINE=pm-cpu # eg, pm-cpu is perlmutter cpu
...
# Set paths
readonly CASE_ROOT="<your_path>"
readonly CODE_ROOT="<your_path>/${CHECKOUT}"
# eg:
# readonly CASE_ROOT="${PSCRATCH}/software/E3SMv3/${CASE_NAME}"
# readonly CODE_ROOT="${PSCRATCH}/software/E3SMv3/code/${CHECKOUT}"
