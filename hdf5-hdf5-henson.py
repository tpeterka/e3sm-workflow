...
#     vol.set_intercomm("*", "*", 0)
    ...
    prod = h.Puppet("/global/homes/t/tpeterka/software/e3sm-workflow/build/src/producer-hdf5.so", [], pm, nm)
...
#     lowfive.create_logger("trace")
    ...
    cons = h.Puppet("/global/homes/t/tpeterka/software/e3sm-workflow/build/src/consumer-hdf5.so", [], pm, nm)
